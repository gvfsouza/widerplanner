                                            ...
                                            <div class="col">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4" id="campos">
                                                        <label for="" style="color: #4e4e4e;"><b>Serviço(s):</b></label>
                                                        <select name="fk_servico[]" id="fk_servico" class="form-control adicionar_servico" style="cursor: pointer;" required>
                                                            ...
                                                            <?php foreach ($listar_servicos as $value) { ?>
                                                                <option value="<?php echo $value->id; ?>" data-nome="<?php echo utf8_encode($value->nome_servico); ?>"><?php echo utf8_encode($value->nome_servico); ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
