                    ...
                    <div class="tab-pane fade show active" id="" role="tabpanel">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="text-right">
                                <button href="<?php echo base_url(); ?>/agendamento/" type="submit" name="salvar" class="btn-lg btn" style="border: none;background-color: #82a4ef;color: white;" value="1">Salvar</button>
                            </div>
                        </form>
                    </div>
                </div>
