<div class="container-fluid" style="margin-top:30px">
  <div class="card shadow mb-4">
    <div class="card-header py-3" style="background-color: white;">
      ...
      <div>
        <h3 id="dados-cleinte" style="font-size: 25px;"><b>Cadastro de Serviços</b></h3><br>
      </div>
                      ...
                      <div class="col">
                        <div class="row">
                          ...
                          <div class="dados-cliente form-group col-md-4">
                            ...
                            <br>
                            <textarea type="text" class="form-control" id="descricao_servico" name="descricao_servico" maxlength="14" rows="4" cols="50"></textarea>
                          </div>
                          <div class="dados-cliente form-group col-md-4">
