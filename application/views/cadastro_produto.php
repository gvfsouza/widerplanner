                                            ...
                                            <div class="col">
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <br>
                                                        <input style="font-size:14px" type="file" class="form-control"
                                                            id="nome_produto" name="nome_produto" value="">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    <div class="dados-produto col-md-6">
                                                        ...
                                                        <input style="font-size:14px" type="number" class="form-control"
                                                            id="quant_produto" name="quant_produto" value="">
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label for=""><b>Descrição do Serviço:</b></label>
                                                        <br>
                                                        <textarea type="text" class="form-control"
                                                            id="descricao_servico" name="descricao_servico"
                                                            maxlength="14" rows="3" cols="50"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
