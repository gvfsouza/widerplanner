                    ...
                    <div class="tab-pane fade show active" id="" role="tabpanel">
                        <form action="">
                            <div class="p-3 bg-white">
                                <div class="row">
                                    <p style="font-size: 18px; float: right"><strong>Barbearia GAVAZ </strong> <br> CNPJ: 31.458.001/0001-08 <br> <b>Dados de localização:</b> Av Dom Pedro I, 1226, Centro, Salto/SP - box 205 (ao lado do cinema)</p>
                                    <div class="col-12">
