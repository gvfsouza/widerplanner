                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input style="font-size:14px" type="text"
                                                                class="form-control" id="foto_servico"
                                                                name="foto_servico" value="">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="" style="color: #4e4e4e;"><b>Nome do
                                                                    Serviço:</b></label>
                                                            <br>
                                                            <input style="font-size:14px" type="text"
                                                                class="form-control" id="nome_servico"
                                                                name="nome_servico" value="">
                                                        </div>
                                                        <div class="dados-cliente form-group col-md-12">
                                                            <label for=""
                                                                style="color: #4e4e4e;"><b>Descrição:</b></label>
                                                            <br>
                                                            <textarea class="form-control" name="descricao_servico"
                                                                id="descricao_servico" cols="5" rows="3"></textarea>
                                                        </div>
                                                        <div class="dados-cliente form-group col-md-6">
                                                            <label for="" style="color: #4e4e4e;"><b>Valor:</b></label>
                                                            <br>
                                                            <input type="number" class="form-control"
                                                                id="valor_servico" name="valor_servico" value="">
                                                        </div>
                                                        <div class="dados-cliente form-group col-md-6">
                                                            <label for=""
                                                            ...
                                                            <input style="font-size:14px" type="time"
                                                                class="form-control" id="duracao_servico"
                                                                name="duracao_servico" value="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
