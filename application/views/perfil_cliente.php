            ...
            <div class="card-header py-3" style="background-color: white;">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="row">
                                                        <legend class="form-group"
                                                            style="color: #879bc9; font-size: 18px; margin-left:14px">
                                                        ...
                                                        <div class="dados-cliente form-group col-md-2">
                                                            ...
                                                            <br>
                                                            <input style="font-size:14px" type="text"
                                                                class="form-control" id="sexo" name="sexo" value=""
                                                                disabled="">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="dados-cliente col-md-3">
                                                            ...
                                                            <input style="font-size:14px" type="text"
                                                                class="form-control" id="cep" name="cep" value="">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="dados-cliente col-md-7">
                                                            ...
                                                            <input style="font-size:14px" type="text"
                                                                class="form-control" id="cidade" name="cidade" value="">
                                                        </div>
                                                        <div class="dados-cliente col-md-5">
                                                            <label for="" style="color: #77787a;">UF:</label>
                                                            <input style="font-size:14px" type="text"
                                                                class="form-control" id="uf" name="uf" value="">
                                                        </div>
                                                    </div>
                                                </div>
                                        </fieldset>
                ...
                <form action="">
                    <div class="p-3 bg-white">
                        <div class="row">
                            <div class="col-12">
                                <fieldset class="form-group"
                                    style="border: 1px solid #ddd; border-radius: 4px; padding: 7px; border: 1px solid #879bc9;background: #879bc9;color: black;">
                                    <div>
                                        <legend class="form-group" style="color: white; font-size: 18px;"> <i
                        ...
                        <fieldset class="form-group"
                            style="border: 1px solid #ddd; border-radius: 4px; padding: 7px; border: 1px solid #879bc9;color: black;">
